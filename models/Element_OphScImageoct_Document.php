...
/**
 * This is the model class for table "et_ophscimageoct_document".
 *
...
class Element_OphScImageoct_Document extends ElementScannedDocument
{
	public $service;
	...
	{
		return 'et_ophscimageoct_document';
	}
